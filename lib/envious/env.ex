defmodule Envious.Env do
  @moduledoc """
  Functions for working with environment variables in configuration files.

  This module provides convenient functions for extracting and converting environment
  variables from `System.get_env/1`. These functions are designed to work seamlessly
